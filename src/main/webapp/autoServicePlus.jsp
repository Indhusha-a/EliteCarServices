...
<html>
<head>
  <title>Elite Car Services - Auto Service Plus</title>
...
<div class="container mx-auto p-6">
  <div class="bg-white p-6 rounded shadow-md">
    <h2 class="text-2xl font-bold mb-4 text-center">Auto Service Plus</h2>
    <p class="text-gray-700 mb-6">Mechanical and cosmetic exterior and interior services to give your car a fresh look according to manufacturer standards.</p>

...
<html>
<head>
    <title>Elite Car Services - Total Care Plus</title>
...
<div class="container mx-auto p-6">
    <div class="bg-white p-6 rounded shadow-md">
        <h2 class="text-2xl font-bold mb-4 text-center">Total Care Plus</h2>
        <p class="text-gray-700 mb-6">Bringing European quality to the automotive service segment according to Euro manufacturer specs. Combining the interior refresh package with the exquisite handmade black magic wax range to bring out the best appearance.</p>
